...
temperature_file = sc.textFile("/user/x_arved/Lab1/temperature-readings.csv")
...
max_temperatures_sorted = max_temperatures.sortBy(ascending=False, keyfunc = lambda k: k[2])
min_temperatures_sorted = min_temperatures.sortBy(ascending=False, keyfunc = lambda k: k[2])
